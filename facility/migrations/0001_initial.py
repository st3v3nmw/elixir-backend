            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("HOME", "Home"),
                            ("HOSPICE_ALTERNATIVE_HOME", "Hospice Alternative Home"),
                            (
                                "HOSPICE_HEALTHCARE_FACILITY",
                                "Hospice HealthCare Facility",
                            ),
                            ("ACUTE_CARE_FACILITY", "Acute Care Facility"),
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="secondary_diagnoses", to="facility.icd10"
                    ),
                ),
            ],
            options={
