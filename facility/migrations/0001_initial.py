    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PLANNED', 'Planned'), ('ARRIVED', 'Arrived'), ('TRIAGED', 'Triaged'), ('IN_PROGRESS', 'In Progress'), ('ONLEAVE', 'Onleave'), ('FINISHED', 'Finished'), ('CANCELLED', 'Cancelled'), ('ENTERED_IN_ERROR', 'Entered in Error')], max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start', models.DateTimeField(default=django.utils.timezone.now)),
                ('end', models.DateTimeField(null=True)),
                ('discharge_disposition', models.CharField(choices=[('HOME', 'Home'), ('HOSPICE_ALTERNATIVE_HOME', 'Hospice Alternative Home'), ('HOSPICE_HEALTHCARE_FACILITY', 'Hospice HealthCare Facility'), ('ACUTE_CARE_FACILITY', 'Acute Care Facility'), ('OTHER_HEALTH_FACILITY', 'Other Health Facility'), ('EXPIRED', 'Expired'), ('LEFT_AGAINST_MEDICAL_ADVICE', 'Left Against Medical Advice'), ('NOT_DOCUMENTED', 'Not Documented')], max_length=64)),
                ('invoice_number', models.CharField(max_length=32, unique=True)),
                ('status', models.CharField(choices=[('DRAFT', 'Draft'), ('FINALIZED', 'Finalized')], max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', models.IntegerField()),
                ('is_paid', models.BooleanField(default=False)),
                ('encounter', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='services', to='facility.encounter')),
