    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('DRAFT', 'Draft'), ('PENDING', 'Pending'), ('APPROVED', 'Approved'), ('REJECTED', 'Rejected'), ('WITHDRAWN', 'Withdrawn')], default='PENDING', max_length=16)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visit_type', models.CharField(choices=[('OUTPATIENT', 'Outpatient'), ('INPATIENT', 'Inpatient'), ('DENTAL', 'Dental'), ('OPTICAL', 'Optical')], max_length=16)),
                ('is_released', models.BooleanField(default=True)),
                ('facility', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='records', to='index.facility')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('facility', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='index.facility')),
                ('practitioner', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='employment_history', to='index.practitioner')),
            ],
            options={
                'ordering': ['-start'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('completeness', models.IntegerField(validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(5)])),
                ...
                ('record', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='ratings', to='index.record')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consent_request', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='transition_logs', to='index.consentrequest')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='record',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='consent_requests', to='index.record'),
        ),
        migrations.AddField(
            model_name='consentrequest',
            name='requestor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='index.tenure'),
        ),
        migrations.CreateModel(
            name='AccessLog',
            fields=[
                ...
                ('practitioner', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='index.tenure')),
                ('record', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='access_logs', to='index.record')),
            ],
            options={
                'abstract': False,
            },
